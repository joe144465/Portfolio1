      ...
      <div className="flex flex-col lg:flex-row w-full bg-gray-900 gap-10 p-6 sm:p-8 md:p-10">
        ...
        >
          ...
          <p className="text-white text-[16px] md:text-xl font-regular font-roboto text-center lg:text-left">
            ...
            productivity tools. Skilled in creating responsive web applications,
            managing enterprise environments, and building automated workflows
            that improve efficiency. Strong technical foundation in both Windows
            and Linux servers, with expertise in Microsoft 365 ecosystem, data
...
<section id="about">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-10">
          <div className=" flex-1 p-6 sm:p-8 md:p-10 rounded-lg flex flex-col lg:ml-20">
            ...
            <p className="text-white text-[16px] md:text-xl font-regular font-roboto text-left">
              ...
              A cazy front-end developer and I really like Linux OS a lot.I love
              to play guitar and listen to music.
            </p>
            <img
              src={img}
              alt="speaking"
              className="w-140 h-140 object-cover shadow-lg  shadow-gray-900 rounded-lg "
            />
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.7 }}
            className=" flex-1 p-6 sm:p-8 md:p-10 rounded-lg flex flex-col lg:mr-20"
          >
      ...
      <div className="bg-gray-900 p-6 sm:p-8 md:p-10">
        <h1 className="text-white text-6xl font-sen  md:ml-10 lg:ml-30 ">
          Education
        </h1>
        ...
        <div className="flex items-center md:ml-10 lg:ml-30 mt-10 gap-8 flex-col lg:flex-row md:flex-row relative cursor-pointer after:absolute after:bottom-[-20px] after:left-0 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-3/4 ">
          ...
          <h1 className="text-white text-3xl  font-regular font-inter">
      ...
      <div className="bg-gray-900 p-6 sm:p-8 md:p-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 md:ml-10 lg:ml-30">
          <Expcard
            logo={card}
      ...
      <div className="bg-gray-900 p-6 sm:p-8 md:p-10 flex flex-col ">
        <h1 className="text-white text-6xl font-sen lg:ml-30 ">Contact Me</h1>
        <p className="text-white text-lg md:text-2xl font-regular font-roboto lg:ml-30 mt-20">
          ...
          If you have a good opportunity that matches my skills and experience, contact me.</p>
          <p className="text-white text-lg md:text-2xl font-regular font-roboto lg:ml-30 mt-4">Discuss a project or just want to say hi? My Inbox is open for all.</p>
